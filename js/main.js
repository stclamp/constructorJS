...
const createHeader = ({ title, header: {logo, social, menu } }) => {
	...
	const menuHumburger = getElement('button', ['menu-button']);

	
	header.append(container);
	container.append(wrapper, menuHumburger);
...
const movieConstructor = (selector, options) => {
	...
	const menuButton = document.querySelector('.menu-button');
	const menuElem = document.querySelector('.header');
	menuButton.addEventListener('click', function () {
		menuButton.classList.toggle('menu-button-active');
		menuElem.classList.toggle('header-active');
	})
};
